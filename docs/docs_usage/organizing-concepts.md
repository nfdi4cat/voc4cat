...
| 4   | voc4cat:0000186     | Attributes                    | A property that an entity has rather than is: a quantity, whose value has a magnitude, or a nominal property, whose value is a name or a code. E.g., reaction rate, sample mass, catalyst form, stirrer type. | reaction rate, sample mass, catalyst form, stirrer type |
